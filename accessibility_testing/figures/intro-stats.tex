\begin{figure*}[t]
  ...
  % \begin{figure}[b]
    \centering
    \includegraphics[width=0.88\columnwidth,height=5.0cm]{accessibility_testing/figures/population-plot}
    % \hspace{1cm}
  ...
  % \begin{figure}[b]
    \centering
    \includegraphics[width=0.91\columnwidth,height=5.0cm]{accessibility_testing/figures/lawsuits-plot}
